...
public class ExtendedPlayerTut implements IExtendedEntityProperties
{
/*
...
*/
public ExtendedPlayerTut(EntityPlayer player)
{
this.player = player;
...
{
player.registerExtendedProperties(ExtendedPlayerTut.EXT_PROP_NAME, new ExtendedPlayerTut(player));
}
...
* This method is for convenience only; it will make your code look nicer
*/
public static final ExtendedPlayerTut get(EntityPlayer player)
{
return (ExtendedPlayerTut) player.getExtendedProperties(EXT_PROP_NAME);
}
